...
// // function detectGaze(faceLandmarks) {
// //   const leftEyeInner = faceLandmarks[133];
// //   const leftEyeOuter = faceLandmarks[33];
// //   const leftPupil = calculateMidpoint(faceLandmarks[159], faceLandmarks[145]);

// //   const rightEyeInner = faceLandmarks[362];
// //   const rightEyeOuter = faceLandmarks[263];
// //   const rightPupil = calculateMidpoint(faceLandmarks[386], faceLandmarks[374]);
...
// //       const gazeDirection = detectGaze(faceLandmarks);
// //       status.textContent = `Status: ${gazeDirection}`;
...
// function detectGaze(faceLandmarks) {
//   // Key points for the left eye
//   const leftEyeInner = faceLandmarks[133];
//   const leftEyeOuter = faceLandmarks[33];
//   const leftPupil = calculateMidpoint(faceLandmarks[159], faceLandmarks[145]);

//   // Key points for the right eye
//   const rightEyeInner = faceLandmarks[362];
//   const rightEyeOuter = faceLandmarks[263];
//   const rightPupil = calculateMidpoint(faceLandmarks[386], faceLandmarks[374]);

//   // Ratios for gaze detection
//   const leftEyeRatio =
//     Math.abs(leftPupil[0] - leftEyeInner.x) /
//     Math.abs(leftEyeOuter.x - leftEyeInner.x);
...
//   // Average gaze ratio
//   const gazeRatio = (leftEyeRatio + rightEyeRatio) / 2;

//   // Add threshold adjustments for better accuracy
//   if (gazeRatio < 0.35) {
//     return "Looking left";
...
//     maxNumFaces: 1,
//     refineLandmarks: true,
//     minDetectionConfidence: 0.75, // Increase detection confidence
//     minTrackingConfidence: 0.75, // Increase tracking confidence
//   });
